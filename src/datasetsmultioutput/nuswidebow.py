...
class NusWideBoW(base.RemoteDataset):
    """
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            n_features=501,
            n_outputs=81,
            url="http://www.uco.es/grupos/kdis/MLLResources/ucobigfiles/Datasets/Full/Nuswide_BoW_Meka.zip",
            unpack=True,
            filename="Nuswide_BoW.arff",
            size=1_054_139_716,
        )
